...
const FormItem = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement> & PropsWithClassName>(
  ({ className, ...props }, ref) => {
...
const FormLabel = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof LabelPrimitive.Root> & PropsWithClassName
>(({ className, ...props }, ref) => {
